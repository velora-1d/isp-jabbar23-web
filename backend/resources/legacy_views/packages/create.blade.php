    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm mt-1">Buat paket bandwidth internet baru</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('packages.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="speed_up" name="speed_up" value="{{ old('speed_up') }}"
                                        class="w-full pl-12 pr-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                ...
                                placeholder="Cocok untuk streaming dan gaming...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
