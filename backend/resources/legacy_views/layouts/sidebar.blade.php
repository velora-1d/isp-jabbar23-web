<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-700/50 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900" aria-label="Sidebar" 
   ...
   <div x-ref="sidebarContent" 
      ...
      <ul class="space-y-2 font-medium">
         ...
         @hasanyrole('super-admin|admin|sales-cs|technician')
         ...
         <div x-show="open === 'billing'" x-collapse>
            ...
            <x-menu-item route="expenses.index" label="Pengeluaran" color-from="rose-500" color-to="red-600">
               <x-slot:icon><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3 2-1.343 2-3 2M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg></x-slot:icon>
            </x-menu-item>
         ...
         @hasanyrole('super-admin|admin|noc|technician')
         <li class="px-2 pt-4 pb-1">
         ...
         {{-- Hotspot System - super-admin, admin, sales --}}
         @hasanyrole('super-admin|admin|sales-cs')
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'hotspot' ? '' : 'hotspot'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">Sistem Hotspot</span>
               <svg class="w-4 h-4 transition-transform" :class="open === 'hotspot' ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
         </li>
         <div x-show="open === 'hotspot'" x-collapse>
            <x-menu-item route="hotspot.vouchers.index" label="Kelola Voucher" color-from="purple-500" color-to="indigo-600">
            ...
            <x-menu-item route="hotspot.profiles.index" label="Profil Voucher" color-from="indigo-500" color-to="blue-600">
         ...
         @hasanyrole('super-admin|admin|sales-cs|noc|technician')
         <li class="px-2 pt-4 pb-1">
         ...
         <div x-show="open === 'reports'" x-collapse>
            ...
            <x-menu-item route="reports.profit-loss" label="Laba Rugi & PPN" color-from="teal-400" color-to="cyan-600">
               <x-slot:icon><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg></x-slot:icon>
            </x-menu-item>
