<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-white leading-tight">{{ __('Tambah Pelanggan Baru') }}</h2>
                <p class="text-gray-400 text-sm mt-1">Daftarkan langganan baru</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <div class="pb-6 border-b border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    <label for="email" class="block text-sm font-semibold text-gray-300 mb-2">Email
                                        (Opsional)</label>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <textarea id="address" name="address" rows="2"
                                        ...
                                        placeholder="Jl. Merdeka No. 123" required>{{ old('address') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" required
                                        ...
                                        @foreach($statuses as $key => $label)
                                            <option value="{{ $key }}" {{ old('status', 'registered') == $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="team_size" class="block text-sm font-semibold text-gray-300 mb-2">Jumlah
                                        Tim</label>
                                    <input type="number" id="team_size" name="team_size" value="{{ old('team_size') }}"
                                        min="1" max="10"
                                        class="w-full px-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
