<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-700/50 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900" aria-label="Sidebar" x-data="{ open: localStorage.getItem('sidebarOpen') || '' }">
   <div class="h-full px-3 pb-4 overflow-y-auto">
      <ul class="space-y-2 font-medium">
         ...
         {{-- Dashboard --}}
         <x-menu-item route="dashboard" label="Dashboard" color-from="blue-500" color-to="cyan-500">
         ...
         {{-- CRM & Sales --}}
         @hasanyrole('super-admin|admin|sales|finance')
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'crm' ? '' : 'crm'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">CRM & Sales</span>
         ...
         <div x-show="open === 'crm'" x-collapse>
            <x-menu-item route="leads.index" label="Leads/Prospects" color-from="cyan-500" color-to="teal-500">
            ...
            <x-menu-item route="customers.index" label="Customers" color-from="sky-500" color-to="blue-600">
            ...
            <x-menu-item route="contracts.index" label="Contracts" color-from="indigo-500" color-to="purple-600">
            ...
            <x-menu-item route="partners.index" label="Partners" color-from="teal-500" color-to="emerald-600">
         ...
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'billing' ? '' : 'billing'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">Billing & Finance</span>
         ...
         <div x-show="open === 'billing'" x-collapse>
            <x-menu-item route="invoices.index" label="Invoices" color-from="purple-500" color-to="indigo-600">
               <x-slot:icon><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></x-slot:icon>
            </x-menu-item>
            <x-menu-item route="payments.index" label="Payments" color-from="blue-500" color-to="indigo-600">
            ...
            <x-menu-item route="billing.recurring" label="Recurring Billing" color-from="violet-500" color-to="purple-600">
            ...
            <x-menu-item route="billing.credit-notes" label="Credit Notes" color-from="rose-500" color-to="red-600">
            ...
            <x-menu-item route="reports.index" label="Financial Reports" color-from="pink-500" color-to="rose-600">
            ...
            <x-menu-item route="settings.payment-gateways" label="Payment Gateways" color-from="cyan-500" color-to="blue-600">
         ...
         {{-- Network --}}
         @hasanyrole('super-admin|admin|technician')
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'network' ? '' : 'network'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">Network</span>
         ...
         <div x-show="open === 'network'" x-collapse>
            <x-menu-item route="network.monitoring.index" label="Net Monitor (Ping)" color-from="blue-500" color-to="cyan-600">
            ...
            <x-menu-item route="network.olts.index" label="OLT Management" color-from="cyan-500" color-to="teal-600">
         ...
         <div x-show="open === 'support'" x-collapse>
            <x-menu-item route="tickets.index" label="Tickets" color-from="red-500" color-to="orange-600">
            ...
            <x-menu-item route="messages.index" label="Customer Messages" :soon="true" color-from="orange-500" color-to="amber-600">
         ...
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'field' ? '' : 'field'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">Field Operations</span>
         ...
         <div x-show="open === 'field'" x-collapse>
            <x-menu-item route="technicians.index" label="Technicians" color-from="emerald-500" color-to="teal-600">
            ...
            <x-menu-item route="work-orders.index" label="Work Orders" color-from="lime-500" color-to="green-600">
            ...
            <x-menu-item route="reports.installation" label="Installation Reports" :soon="true" color-from="cyan-500" color-to="blue-600">
               <x-slot:icon><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg></x-slot:icon>
            </x-menu-item>
         </div>
         @endhasanyrole
         ...
         {{-- Inventory --}}
         @hasanyrole('super-admin|admin|finance|technician')
         <li class="px-2 pt-4 pb-1">
         ...
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'hrd' ? '' : 'hrd'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">HRD</span>
         ...
         <li class="px-2 pt-4 pb-1">
            <button @click="open = open === 'marketing' ? '' : 'marketing'; localStorage.setItem('sidebarOpen', open)" class="w-full flex items-center justify-between text-gray-500 hover:text-gray-300 transition">
               <span class="text-xs font-semibold uppercase tracking-wider">Marketing</span>
         ...
         <div x-show="open === 'marketing'" x-collapse>
            ...
            <x-menu-item route="promotions.index" label="Promotions" :soon="true" color-from="fuchsia-500" color-to="pink-600">
         ...
         <div x-show="open === 'settings'" x-collapse>
            <x-menu-item route="packages.index" label="Packages" color-from="amber-500" color-to="orange-600">
            ...
            <x-menu-item route="settings.index" label="General Settings" color-from="gray-500" color-to="slate-600">
               <x-slot:icon><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg></x-slot:icon>
            </x-menu-item>
         ...
         <li class="pt-6 mt-4 border-t border-gray-700/50">
            <form method="POST" action="{{ route('logout') }}">
               ...
               <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="flex items-center p-3 rounded-xl transition-all duration-200 group text-gray-400 hover:bg-red-500/10 hover:text-red-400">
                  ...
                  <span class="flex-1 ms-3 font-semibold">Sign Out</span>
               </a>
            </form>
         </li>
      </ul>
